...
- [ ] 仕様書 `docs/spec/3-9`, `docs/spec/3-6` とガイド `docs/guides/runtime/runtime-bridges.md` を stub メタデータ/計測 API 情報で更新し、`docs/notes/process/licensing-todo.md` の TODO 消化を記録
