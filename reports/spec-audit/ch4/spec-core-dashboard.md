...
| `CH1-MOD-003` | `examples/spec_core/chapter1/module_use/bnf-compilationunit-module-use-alias-ok.reml` | — | — | 0 | ✅ pass | 2025-12-09 PhaseF: `cargo run --manifest-path compiler/rust/frontend/Cargo.toml --bin reml_frontend -- --output json examples/spec_core/chapter1/module_use/bnf-compilationunit-module-use-alias-ok.reml` で診断 0 / log=`reports/spec-audit/ch4/logs/spec_core-20251209T093700Z.md`。 |
| `CH1-MOD-004` | `examples/spec_core/chapter1/module_use/bnf-usedecl-super-root-invalid.reml` | `language.use.invalid_super` | `language.use.invalid_super` | 1 | ✅ pass | 2025-12-09 PhaseF: `cargo run --manifest-path compiler/rust/frontend/Cargo.toml --bin reml_frontend -- --output json examples/spec_core/chapter1/module_use/bnf-usedecl-super-root-invalid.reml` で期待診断 / log=`reports/spec-audit/ch4/logs/spec_core-20251209T093700Z.md`。 |
