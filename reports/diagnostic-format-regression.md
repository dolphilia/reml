...
- レビュー: `docs/plans/bootstrap-roadmap/3-1-core-prelude-iteration-plan.md` §4.a G3、`docs/notes/core-library-outline.md#iter-g3-buffered-backpressure`、`docs/plans/bootstrap-roadmap/0-3-audit-and-metrics.md`、`docs/plans/bootstrap-roadmap/3-0-phase3-self-host.md#iter-adapter` にリンクを貼り、リングバッファ容量・バックプレッシャ・Stage 情報がすべてのドキュメントで同期していることを監査する。
