...
- **Windows 固有**: `collect-iterator-audit-metrics.py --require-success --profile windows-msvc`（P0 で新設予定）を追加し、MSVC/MinGW 双方の `stage_mismatch_count` を収集する。詳細手順は `0-2-windows-toolchain-audit.md` に記載。
