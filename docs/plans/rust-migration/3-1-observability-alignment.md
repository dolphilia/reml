...
| `parser.stream.packrat_hit` | `collect-iterator-audit-metrics.py --section streaming` | Rust パーサで Packrat 統計を導入し、`reports/audit/streaming-*-rust.json` へ出力 | `docs/guides/compiler/core-parse-streaming.md` 参照 |
