...
4. `docs/guides/ffi/ffi-dsl-guide.md` に FFI DSL 導入ガイドを新設し、Phase 1 の `reml-bindgen` 生成物との併用フローを明記する。
...
- 実装ステップ 4: `docs/guides/ffi/ffi-dsl-guide.md` を更新し、`reml-bindgen` 併用フローを明記済み。
