...
- 最新同期: Active Pattern の記法・BNF・診断キーに加え、`match` 評価順（Partial Active の `None` フォールスルー含む）を `docs/spec/1-5-formal-grammar-bnf.md` と `docs/guides/core-parse-streaming.md` 付録Aへ同期し、CH1-MATCH 系マトリクス更新を進行中。
