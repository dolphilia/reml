...
[^lexer001-phase25]: `docs/notes/dsl-plugin-roadmap.md` §7「Unicode プロファイル導入準備」および `docs/plans/bootstrap-roadmap/2-5-review-log.md` 2026-03-04 記録を参照。Phase 2-5 Step3 で ASCII 限定ポリシーと Phase 2-7 フォローアップ TODO を確定。
