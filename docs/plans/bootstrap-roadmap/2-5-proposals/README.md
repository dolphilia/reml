...
- [DIAG-003 修正計画](./DIAG-003-proposal.md): `DiagnosticDomain` を効果・プラグイン・LSP など仕様準拠の語彙へ拡張し、監査ログ分析を改善。2025-11-27 更新: シリアライズ/スキーマ/ゴールデン整備（`domain.other` 拡張、Plugin/Lsp/Other サンプル）が完了し、残課題は CI 指標の拡充へ引き継ぎ。
