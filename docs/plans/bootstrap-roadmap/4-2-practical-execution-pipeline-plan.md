...
## スコープ
- **含む**: `tooling/examples/run_examples.sh` のスイート拡張、`compiler/rust/tests/practical/` の e2e テスト整備、`.github/workflows/phase4-practical.yml`（仮）の作成、`reports/spec-audit/ch5/` への実行ログ出力、Golden ファイル更新フローの策定。
