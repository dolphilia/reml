...
| DOC-03 | `docs/guides/core-parse-streaming.md` | `decode_stream` API 公開 | Streaming 例と Unicode 注意事項の追記 | Y | Done (2027-03-30) | §10 decode_stream + TextBuilder を追加 |
| DOC-04 | `docs/guides/ai-integration.md` | Text 正規化ポリシー決定 | AI 入出力フローに正規化ステップを追加 | Y | Done (2027-03-30) | §6 Normalize/prepare_identifier/`examples/core-text` 参照を追記 |
