...
| IO | `chapter3.io` | `docs/spec/3-5-core-io-path.md§7` | `examples/practical/core_io/file_copy/canonical.reml`, `examples/practical/core_path/security_check/relative_denied.reml` | Core.IO / Core.Path の Reader/Writer, SecurityPolicy を扱う。`reports/spec-audit/ch3/core_io_summary-20251201.md` の監査指標と紐付ける。 |
