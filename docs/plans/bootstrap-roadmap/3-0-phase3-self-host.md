...
9. **横断タスク**
   - API ドキュメント・サンプル・ガイド（`docs/guides/runtime/runtime-bridges.md`, `docs/notes/dsl-plugin-roadmap.md` 等）を更新。
