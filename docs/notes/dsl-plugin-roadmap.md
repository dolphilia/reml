...
[^lexer001-phase25]: `docs/plans/bootstrap-roadmap/2-5-proposals/LEXER-001-proposal.md` Phase 2-5 Step3（DSL/プラグインチーム連携）で策定した ASCII 限定ポリシーと Phase 2-7 に向けた Unicode プロファイル導入ロードマップ。
