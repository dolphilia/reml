...
- **診断スナップショット**: `expected/spec_core/chapter2/op_builder/*.diagnostic.json` を DSL 版で再取得し、`reports/spec-audit/ch4/spec-core-dashboard.md` の Pass/Fail と Run ID を紐付ける。差分が発生した場合は `docs/notes/examples-regression-log.md` へ記録し、再現手順を残す。
