...
## 実装概要
- `compiler/rust/runtime/src/diagnostics/metric_point.rs`
...
- `compiler/rust/runtime/src/diagnostics/audit_bridge.rs`
...
- `compiler/rust/runtime/src/registry.rs`
...
- `compiler/rust/runtime/tests/metrics_capability.rs`
...
## 検証手順
- Rust Runtime 単体
  - `cargo test --manifest-path compiler/rust/runtime/Cargo.toml --features core_numeric,core_time metrics_capability stage_mismatch_produces_guard_diagnostic`
...
- `docs/notes/runtime-capability-stage-log.md`（metrics 行を追加済み）
