...
- **Rust**（`docs/spec/0-0-overview.md`, `docs/spec/1-1-syntax.md`, `docs/notes/stdlib/core-library-scope.md`）
...
- **Rust / F# / OCaml 標準ライブラリ**（`docs/notes/stdlib/core-library-scope.md`）
