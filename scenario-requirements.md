...
| 高精度なエラー診断 | ⬛ 効果に `audit` 追加 (K) | ✅ `2-5` 拡張完了 | ✅ LSP/ログ ガイド更新 |
| DSL プラグイン拡張 | ⬛ プラグイン構文 (B.7) | ✅ Parser capability 仕様確定 | ✅ DSL パッケージガイド更新 |
| ツール連携 | ✅ overview/コア整備 | ✅ `2-6` 連携 API 確定 | ✅ LSP/CI ガイド整備 |
| 型システム拡張 | ⬛ ドメイン型 (J) | ✅ `Core.Data` 章確定 | ✅ データモデルリファレンス新設 |
| 実行基盤連携 | ⬛ 効果指針 (K.2) | ✅ 差分/ホットリロード API 確定 | ✅ Runtime Bridges ガイド拡充 |
