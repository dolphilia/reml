...
| 高精度なエラー診断 | ⬛ 効果に `audit` 追加 (K) | ⬜ `2-5` 拡張 | ⬜ LSP/ログ ガイド |
| DSL プラグイン拡張 | ⬛ プラグイン構文 (B.7) | ⬜ Parser capability | ⬜ DSL パッケージガイド |
| ツール連携 | ⬜ (overview/コア追記予定) | ⬜ `2-6` 連携 API | ⬜ LSP/CI ガイド |
| 型システム拡張 | ⬜ ドメイン型 (J) | ⬜ `Nest.Data` 章 | ⬜ データモデルリファレンス |
| 実行基盤連携 | ⬜ 効果指針 (K.2) | ⬜ 差分/ホットリロード API | ⬜ Runtime Bridges ガイド |
