...
- [3.0 Phase 3 — Core Library 完成](plans/bootstrap-roadmap/3-0-phase3-self-host.md)
  - [3.1 Core Prelude & Iteration 実装計画](plans/bootstrap-roadmap/3-1-core-prelude-iteration-plan.md)
  - [3.2 Core Collections 実装計画](plans/bootstrap-roadmap/3-2-core-collections-plan.md)
  - [3.3 Core Text & Unicode 実装計画](plans/bootstrap-roadmap/3-3-core-text-unicode-plan.md)
  - [3.4 Core Numeric & Time 実装計画](plans/bootstrap-roadmap/3-4-core-numeric-time-plan.md)
  - [3.5 Core IO & Path 実装計画](plans/bootstrap-roadmap/3-5-core-io-path-plan.md)
  - [3.6 Core Diagnostics & Audit 実装計画](plans/bootstrap-roadmap/3-6-core-diagnostics-audit-plan.md)
  - [3.7 Core Config & Data 実装計画](plans/bootstrap-roadmap/3-7-core-config-data-plan.md)
  - [3.8 Core Runtime & Capability 実装計画](plans/bootstrap-roadmap/3-8-core-runtime-capability-plan.md)
