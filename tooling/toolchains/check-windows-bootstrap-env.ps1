...
$checks = @(
    ...
    @{
        ...
        Category = "compiler"
        Required = $true
        MinimumVersion = "20220210"
        VersionCommand = { menhir --version }
    },
    @{
