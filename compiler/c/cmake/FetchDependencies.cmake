...
reml_declare_dependency(argparse https://github.com/cofyc/argparse.git v1.1)
...
reml_declare_dependency(logc https://github.com/rxi/log.c.git 0.1.0)
...
function(reml_make_core_dependencies)
  ...
  add_library(reml_logc STATIC ${logc_SOURCE_DIR}/log.c)
  target_include_directories(reml_logc PUBLIC ${logc_SOURCE_DIR})
endfunction()
