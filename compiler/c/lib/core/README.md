...
- `Core/String.reml` / `Core/Unicode.reml` / `Core/Bytes.reml`: 文字列・Unicode・バイト列の最小 API。
...
| `Core.Unicode.validate_utf8` | `reml_unicode_validate_utf8` | `compiler/c/src/text/unicode.c` |
| `Core.Unicode.is_nfc` | `reml_unicode_is_nfc` | `compiler/c/src/text/unicode.c` |
| `Core.Unicode.normalize_nfc` | `reml_unicode_normalize_nfc` | `compiler/c/src/text/unicode.c` |
| `Core.Unicode.grapheme_len` | `reml_grapheme_len` | `compiler/c/src/text/grapheme.c` |
| `Core.Unicode.grapheme_display_width` | `reml_grapheme_display_width` | `compiler/c/src/text/grapheme.c` |
| `Core.Unicode.grapheme_slice` | `reml_grapheme_slice` | `compiler/c/src/text/grapheme.c` |
| `Core.Unicode.grapheme_advance` | `reml_grapheme_advance` | `compiler/c/src/text/grapheme.c` |
