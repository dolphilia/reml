...
pub enum RemlType {
  ...
  Adt { tag_bits: u32, variants: Vec<RemlType> },
}
...
impl TypeMappingContext {
  ...
  pub fn layout_of(&self, ty: &RemlType) -> TypeLayout {
    match ty {
      RemlType::Bool => TypeLayout { size: 1, align: 1, description: "i1".into() },
      RemlType::I32 => TypeLayout { size: 4, align: 4, description: "i32".into() },
      RemlType::I64 => TypeLayout { size: 8, align: 8, description: "i64".into() },
      RemlType::F64 => TypeLayout { size: 8, align: 8, description: "double".into() },
      RemlType::Pointer => TypeLayout { size: 8, align: 8, description: "ptr".into() },
