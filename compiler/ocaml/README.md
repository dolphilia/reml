...
- `docs/guides/compiler/llvm-integration-notes.md` §5 に準拠した参照カウント (RC) モデルを Phase 1 の OCaml 実装に接続する。
...
- **ドキュメントと CI**: `docs/guides/compiler/llvm-integration-notes.md` および `compiler/ocaml/docs/` を更新し、GitHub Actions でランタイムビルドと検証を自動化。
...
- **仕様・ガイド**: `docs/spec/0-1-project-purpose.md`, `docs/spec/1-1-syntax.md`, `docs/guides/compiler/llvm-integration-notes.md`, `docs/notes/backend/llvm-spec-status-survey.md`
...
詳細な評価レポートは [docs/notes/types/typeclass-performance-evaluation.md](../../docs/notes/types/typeclass-performance-evaluation.md) を参照してください。
