...
**ドキュメント整備**:
- `docs/guides/tooling/diagnostic-format.md` を新規作成
- 診断フォーマット仕様の詳細化
- 出力例とスキーマ定義
...
**ドキュメント整備**:
- `docs/guides/tooling/trace-output.md` を新規作成
- トレース出力の詳細仕様
- メモリ計測方法の説明
...
**ユーザーガイド作成**:
- `docs/guides/tooling/cli-workflow.md` 初稿を作成
...
**ドキュメント**:
9. `docs/guides/tooling/diagnostic-format.md` (新規) - 診断フォーマット仕様
10. `docs/guides/tooling/trace-output.md` (新規) - トレース出力仕様
11. `docs/guides/tooling/cli-workflow.md` (新規) - CLI 使用ガイド
12. `docs/guides/tooling/cli-help-template.md` (新規) - ヘルプテンプレート
