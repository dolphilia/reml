...
let verify_llvm_ir_file llvm_ir_path =
  ...
  | Unix.WEXITED 0 ->
      Ok ()
  | Unix.WEXITED 2 ->
      Error (AssembleError output)
  | Unix.WEXITED 3 ->
      Error (VerifyError output)
  | Unix.WEXITED 4 ->
      Error (CodegenError output)
  | Unix.WEXITED code ->
