...
let assert_quantified_count expected scheme msg =
  ...
  if actual <> expected then
    failwith
      (Printf.sprintf "%s\n  Expected %d quantified vars, got %d" msg expected
         actual)
...
let test_basic_let_polymorphism () =
      ...
      let let_decl =
        {
          ...
          decl_kind =
            LetDecl
              ( {
                  pat_kind = PatVar { name = "id"; span = dummy_span };
                  pat_span = dummy_span;
                },
                None,
                id_lambda );
          ...
          let id_42 =
            {
              expr_kind =
                Call
                  ( {
                      expr_kind = Var { name = "id"; span = dummy_span };
                      expr_span = dummy_span;
                    },
                    [
                      PosArg
          ...
          let let_const =
            {
              ...
              decl_kind =
                LetDecl
                  ( {
                      pat_kind = PatVar { name = "const"; span = dummy_span };
                      pat_span = dummy_span;
                    },
                    None,
                    const_lambda );
              ...
              let const_app =
                {
                  expr_kind =
                    Call
                      ( {
                          expr_kind = Var { name = "const"; span = dummy_span };
                          expr_span = dummy_span;
                        },
                        [
                          PosArg id_42;
                          PosArg
                            {
                              expr_kind = Literal (String ("ignore", Normal));
                              expr_span = dummy_span;
                            };
                        ] );
                  expr_span = dummy_span;
  ...
  Printf.printf
    "  (A4: pattern in let binding - requires tuple pattern support)\n";
  ...
  *)
  ...
  run_test "A6: polymorphic let in block" (fun () ->
      ...
      let block_expr =
        {
          expr_kind = Block [ DeclStmt let_id; ExprStmt tuple_expr ];
          expr_span = dummy_span;
        }
      in
      ...
      let let_id1 =
        {
          ...
          decl_kind =
            LetDecl
              ( {
                  pat_kind = PatVar { name = "id1"; span = dummy_span };
                  pat_span = dummy_span;
                },
                None,
                id1_lambda );
          ...
          let let_id2 =
            {
              ...
              decl_kind =
                LetDecl
                  ( {
                      pat_kind = PatVar { name = "id2"; span = dummy_span };
                      pat_span = dummy_span;
                    },
                    None,
                    {
                      expr_kind = Var { name = "id1"; span = dummy_span };
                      expr_span = dummy_span;
                    } );
              decl_span = dummy_span;
            }
              ...
              let id2_42 =
                {
                  expr_kind =
                    Call
                      ( {
                          expr_kind = Var { name = "id2"; span = dummy_span };
                          expr_span = dummy_span;
                        },
                        [
                          PosArg
...
let test_recursive_polymorphism () =
      ...
      let opt_param =
        {
          pat =
            {
              pat_kind = PatVar { name = "opt"; span = dummy_span };
              pat_span = dummy_span;
            };
          ty = None;
          (* 型パラメータから推論 *)
      ...
      let match_expr =
        {
          expr_kind =
            Match
              ( {
                  expr_kind = Var { name = "opt"; span = dummy_span };
                  expr_span = dummy_span;
                },
                [
                  {
  ...
  (* 今後の拡張用にプレースホルダーを残す *)
  Printf.printf
    "  (B3-B6: Advanced recursive patterns - deferred to future phases)\n"
...
let test_value_restriction () =
      ...
      let let_decl =
        {
          ...
          decl_kind =
            LetDecl
              ( {
                  pat_kind = PatVar { name = "some_val"; span = dummy_span };
                  pat_span = dummy_span;
                },
                None,
                some_42 );
  ...
  Printf.printf
    "  (C4-C6: Effect system value restriction - requires effect tracking)\n"
      ...
      let let_decl =
        {
          ...
          decl_kind =
            LetDecl
              ( {
                  pat_kind = PatVar { name = "add_one"; span = dummy_span };
                  pat_span = dummy_span;
                },
                None,
                add_one_lambda );
          ...
          let add_one_42 =
            {
              expr_kind =
                Call
                  ( {
                      expr_kind = Var { name = "add_one"; span = dummy_span };
                      expr_span = dummy_span;
                    },
                    [
                      PosArg
      ...
      let let_a =
        {
          ...
          decl_kind =
            LetDecl
              ( {
                  pat_kind = PatVar { name = "a"; span = dummy_span };
                  pat_span = dummy_span;
                },
                None,
                {
                  expr_kind = Literal (Int ("10", Base10));
                  expr_span = dummy_span;
                } );
          decl_span = dummy_span;
        }
      ...
      let let_b =
        {
          ...
          decl_kind =
            LetDecl
              ( {
                  pat_kind = PatVar { name = "b"; span = dummy_span };
                  pat_span = dummy_span;
                },
                None,
...
let test_higher_order_functions () =
      ...
      let apply_body =
        {
          expr_kind =
            Call
              ( {
                  expr_kind = Var { name = "f"; span = dummy_span };
                  expr_span = dummy_span;
                },
                [
                  PosArg
                  ...
                  [
                    {
                      pat =
                        {
                          pat_kind = PatVar { name = "f"; span = dummy_span };
                          pat_span = dummy_span;
                        };
                      ty = None;
                      default = None;
      ...
      let g_x =
        {
          expr_kind =
            Call
              ( {
                  expr_kind = Var { name = "g"; span = dummy_span };
                  expr_span = dummy_span;
                },
                [
                  PosArg
                ...
                fn_params =
                  [
                    ...
                    };
                    {
                      pat =
                        {
                          pat_kind = PatVar { name = "g"; span = dummy_span };
                          pat_span = dummy_span;
                        };
                      ty = None;
                      default = None;
  ...
  Printf.printf
    "  (E3-E8: Advanced higher-order functions - deferred to later)\n"
