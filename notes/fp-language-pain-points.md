...
- **新規ガイド `guides/fp-transition.md`（仮）を追加**: 既存の `guides/dsl-first-guide.md` と連携し、命令的思考→関数的思考へのステップ、`Iter` チェーンのリファクタ例、`Effect` 設計の FAQ を掲載する。本文完成後は README のガイド一覧にリンクを追記する。[^2][^5]
